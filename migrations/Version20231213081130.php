 ...
 */
final class Version20231213081130 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Rajout des attributs createdAt et UpdatedAt pour l\'entité User dans la base des données';
    }
